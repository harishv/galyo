var app = angular.module('gallyoApp', []);
...
app.controller('GallyoHome', function ($scope, gallyoHomePageService, $window) {
	// Trending Videos List
	$scope.trendingVideos = gallyoHomePageService.getTrendingVideos();
	// Latest Videos List
	$scope.latestVideos = gallyoHomePageService.getLatestVideos();
